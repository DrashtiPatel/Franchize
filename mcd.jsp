                      ...
                      <h3>Mcd</h3></div>
                        ...
                        %>
                                <table width="500" border="0" cellspacing="10">
                                            <tr>
                                                <td colspan="6" width="17"><a href="mcd.jsp"><img src="images/mcd.jpg"/></a></td>
                                            ...
                                            db.executestatement("select * from fsor_details where email='mcd@gmail.com'");
                                            while(db.r.next())
                                                {
                                                            %>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left"> :-</td>
                                                <td colspan="3"><p>Mcd is an international fast food chian.</p></td>
                                                <td>&nbsp;</td>
                                                <td>&nbsp;</td>
                                            </tr>
                                        </table>
