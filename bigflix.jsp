                      ...
                      <h3>Big Flix</h3></div>
                        <div class="text">
                            <form action="" name="" method="post">
                             ...
                             try {
                                                        ...
                                                        db.connect();
                                                        db.executestatement("select * from fsor_req where email='bigflixpune@gmail.com'");
                                                        while(db.r.next())
                                                            {
                        ...
                        %>
                                <table width="500" border="0" cellspacing="10">
                                            <tr>
                                                <td colspan="6" width="17"><a href="bigflix.jsp"><img src="images/big flix.png"/></a></td>
                                            ...
                                            db.executestatement("select * from fsor_details where email='bigflixpune@gmail.com'");
                                            while(db.r.next())
                                                {
                                                            %>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left"> :-</td>
                                                <td colspan="3"><p>Big Flix is an entertainment provider.</p></td>
                                                <td>&nbsp;</td>
                                                <td>&nbsp;</td>
                                            </tr>
                                        </table>
