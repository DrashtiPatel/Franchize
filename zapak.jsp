                      ...
                      <h3>Zapak</h3></div>
                        ...
                        %>
                                <table width="500" border="0" cellspacing="10">
                                            <tr>
                                                <td colspan="6" width="17"><a href="zapak.jsp"><img src="images/zapak gameplex.jpg"/></a></td>
                                            ...
                                            db.executestatement("select * from fsor_details where email='zapak@gmail.com'");
                                            while(db.r.next())
                                                {
                                                            %>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left"> :-</td>
                                                <td colspan="3"><p>Zapak Gameplex provides software gaming.</p></td>
                                                <td>&nbsp;</td>
                                                <td>&nbsp;</td>
                                            </tr>
                                        </table>
