                      ...
                      <h3>JetKing</h3></div>
                        ...
                        %>
                                <table width="500" border="0" cellspacing="10">
                                            <tr>
                                                <td colspan="6" width="17"><a href="jetking.jsp"><img src="images/jetking.png"/></a></td>
                                            ...
                                            db.executestatement("select * from fsor_details where email='jetkingnet@gmail.com'");
                                            while(db.r.next())
                                                {
                                                            %>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left"> :-</td>
                                                <td colspan="3"><p>Jetking is an institute which provides training in hardware and networking field of computers.</p></td>
                                                <td>&nbsp;</td>
                                                <td>&nbsp;</td>
                                            </tr>                                                                                        
                                        </table>
