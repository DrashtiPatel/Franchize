                      ...
                      <h3>Havmor</h3></div>
                        <div class="text">
                            <form action="" name="" method="post">
                             ...
                             try {
                                                        ...
                                                        db.connect();
                                                        db.executestatement("select * from fsor_req where email='havmor@gmail.com'");
                                                        while(db.r.next())
                                                            {
                        ...
                        %>
                                <table width="500" border="0" cellspacing="10">
                                            <tr>
                                                <td colspan="6" width="17"><a href="havmor.jsp"><img src="images/havmor.jpg"/></a></td>
                                            ...
                                            db.executestatement("select * from fsor_details where email='havmor@gmail.com'");
                                            while(db.r.next())
                                                {
                                                            %>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left"> :-</td>
                                                <td colspan="3"><p>Havmor is a chain of ice cream parlour.</p></td>
                                                <td>&nbsp;</td>
                                                <td>&nbsp;</td>
                                            </tr>
                                        </table>
