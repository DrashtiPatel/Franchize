                      ...
                      <h3>Speed Car Wash</h3></div>
                        <div class="text">
                            <form action="" name="" method="post">
                             ...
                             try {
                                                        ...
                                                        db.connect();
                                                        db.executestatement("select * from fsor_req where email='speedcarwash@gmail.com'");
                                                        while(db.r.next())
                                                            {
                        ...
                        %>
                                <table width="500" border="0" cellspacing="10">
                                            <tr>
                                                <td colspan="6" width="17"><a href="speedcarwash.jsp"><img src="images/speed car wash.gif"/></a></td>
                                            ...
                                            db.executestatement("select * from fsor_details where email='speedcarwash@gmail.com'");
                                            while(db.r.next())
                                                {
                                                            %>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left"> :-</td>
                                                <td colspan="3"><p>Speed Car Wash is a automobiles repairing firm.</p></td>
                                                <td>&nbsp;</td>
                                                <td>&nbsp;</td>
                                            </tr>
                                        </table>
