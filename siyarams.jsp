                      ...
                      <h3>Siyarams</h3></div>
                        ...
                        %>
                                <table width="500" border="0" cellspacing="10">
                                            <tr>
                                                <td colspan="6" width="17"><a href="siyarams.jsp"><img src="images/siyaram.gif"/></a></td>
                                            ...
                                            db.executestatement("select * from fsor_details where email='siyarams@gmail.com'");
                                            while(db.r.next())
                                                {
                                                            %>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left"> :-</td>
                                                <td colspan="3"><p>Siyarams is a men authentic clothing retail chain.</p></td>
                                                <td>&nbsp;</td>
                                                <td>&nbsp;</td>
                                            </tr>
                                        </table>
