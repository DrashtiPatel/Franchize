                      ...
                      <h3>Gitanjali</h3></div>
                        ...
                        %>
                                <table width="500" border="0" cellspacing="10">
                                            <tr>
                                                <td colspan="6" width="17"><a href="gitanjali.jsp"><img src="images/gitanjali.png"/></a></td>
                                            ...
                                            db.executestatement("select * from fsor_details where email='gitanjali@gmail.com'");
                                            while(db.r.next())
                                                {
                                                            %>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left"> :-</td>
                                                <td colspan="3"><p>Gitanjali Gems is a jewelary retail chain.</p></td>
                                                <td>&nbsp;</td>
                                                <td>&nbsp;</td>
                                            </tr>
                                        </table>
